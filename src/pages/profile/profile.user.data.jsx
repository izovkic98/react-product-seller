                ...
                <div className="row">
                    <div id="Content_FormLayoutDataBinding_1" className="col-lg-8">
                        <div className="form-group">
                            <label className="control-label dxbs-fl-cpt" for="Content_FormLayoutDataBinding_teDisplayName_I" style={{fontWeight:700}}>Ime i prezime</label>
                        ...
                        <div className="form-group">
                            <label className="control-label dxbs-fl-cpt" for="Content_FormLayoutDataBinding_tePhone_I" style={{fontWeight:700}}>Telefon</label>
                        ...
                        <div className="form-group">
                            <label className="control-label dxbs-fl-cpt" for="Content_FormLayoutDataBinding_teEmail_I" style={{fontWeight:700}}>Email</label>
